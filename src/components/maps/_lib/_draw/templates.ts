...
const styles = {
  container: 'min-width: 220px; max-height: 300px; overflow-y: auto; scrollbar-width: thin;',
...
export function createPointRow(index: number, lat: string, lng: string): string {
  return `
    <tr>
